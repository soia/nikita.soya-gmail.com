                ...
                >
                    <View>
                        ...
                        <Field
                            ...
                            autoCapitalize="none"
                            placeholder={i18n.t('auth.authenticatorCode')}
                            blurOnSubmit={false}
                            autoFocus={false}
                            autoCorrect={false}
                            returnKeyType="next"
                            error={codeErrors}
                            labelText={i18n.t('auth.authenticatorCode')}
                        />
                    </View>
                    <Button
                        onPress={this.emailConformationSubmit}
                        buttonText={i18n.t('auth.submit')}
...
export default compose(withTranslation, connect(mapStateToProps))(TwoFactorAuth);
